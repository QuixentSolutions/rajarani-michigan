...
const AdminLogin = ({ onLoginSuccess }) => {
  ...
  const styles = {
    ...
    inputFocus: {
      ...
      outline: "none",
      boxShadow:
        "0 0 0 4px rgba(255, 165, 0, 0.15), 0 4px 12px rgba(255, 165, 0, 0.1)",
        ...
        <form onSubmit={handleSubmit}>
          <div style={styles.inputGroup}>
            ...
            <div
              ...
              style={{ opacity: focusedInput === "username" ? 1 : 0 }}
            ></div>
          </div>
          <div style={styles.inputGroup}>
            ...
            <div
              className="form-group-glow"
              style={{ opacity: focusedInput === "password" ? 1 : 0 }}
            ></div>
          </div>
          <button
            type="submit"
            ...
            onMouseEnter={(e) => {
              if (!isLoading) {
                ...
                e.target.style.background =
                  "linear-gradient(135deg, #e69500, #cc7a00)";
              }
            }}
            onMouseLeave={(e) => {
              if (!isLoading) {
