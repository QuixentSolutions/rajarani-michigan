    ...
    <>
                    ...
                    <td style={{
                      ...
                      {order.items.map((item, index) => (
                        <div key={index} style={{
                          ...
                          paddingBottom: index < order.items.length - 1 ? "8px" : "0",
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            padding: "8px 16px",
            backgroundColor: page === kitchenOrders.totalPages ? "#f1f5f9" : "#ffffff",
            color: page === kitchenOrders.totalPages ? "#94a3b8" : "#475569",
            border: "1px solid #e2e8f0",
            borderRadius: "6px",
            cursor: page === kitchenOrders.totalPages ? "not-allowed" : "pointer",
            fontSize: "14px",
            fontWeight: "500",
            transition: "all 0.2s ease"
          }}
